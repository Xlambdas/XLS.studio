...
import { Palette, Type, Ruler, Globe, Wind, RotateCcw } from 'lucide-react';
...
export const AccessibilityPage_save: React.FC = () => {
    ...
    const tabs: TabItem[] = [
        { id: 'colors', label: t.colors.label, icon: Palette, panel: 'colors-panel' },
        { id: 'typography', label: t.typography.label, icon: Type, panel: 'typography-panel' },
        { id: 'sizes', label: t.sizes.label, icon: Ruler, panel: 'sizes-panel' },
        { id: 'language', label: t.language.label, icon: Globe, panel: 'language-panel' },
        { id: 'motion', label: t.motion.label, icon: Wind, panel: 'motion-panel' },
    ];
